...
class TeacherHomeForOthers extends StatelessWidget {
  TeacherHomeForOthers({super.key, required this.userModel , required this.onTapForSend});
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              EditOrSendButton(
                                onTapForSend: (){} ,textButton: "Send message",)
                            ],
                          )
                        ],
                      ),
